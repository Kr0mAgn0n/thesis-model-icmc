...
Nesta seção apresentará-se a formula de representação de Weierstrass que serve para gerar superfícies mínimas em $\R^3$ que foi um problema importante ao inicio do estúdio das superfícies mínimas.
...
Em esta seção apresentará-se alguns resultados sobre superfícies mínimas em $S^3$ focando-se no casso em que a superfície é compacta. Para mais informação pode-se consultar \cite{Brendle2013}.
